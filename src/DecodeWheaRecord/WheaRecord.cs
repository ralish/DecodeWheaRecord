...
namespace DecodeWheaRecord {
    internal abstract class WheaRecord : IWheaRecord {
        ...
        protected WheaRecord(Type sectionType, uint sectionOffset, uint bytesMinimum, uint bytesRemaining) {
        ...
        protected WheaRecord(WHEA_ERROR_RECORD_SECTION_DESCRIPTOR sectionDsc, Type sectionType, uint bytesMinimum, uint bytesRemaining) :
