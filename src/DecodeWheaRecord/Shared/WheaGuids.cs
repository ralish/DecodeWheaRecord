...
namespace DecodeWheaRecord.Shared {
    internal static class WheaGuids {
        ...
        internal static readonly Dictionary<Guid, string> CreatorIds = new Dictionary<Guid, string> {
            // Microsoft
            { DEFAULT_DEVICE_DRIVER_CREATOR_GUID, "Device Driver (default)" }, { WHEA_RECORD_CREATOR_GUID, "Microsoft" }
        };
        ...
        internal static readonly Guid WHEA_DEVICE_ERROR_SUMMARY_GUID = Guid.Parse("990b31e9-541a-4db0-a42f-837d344f6923");
