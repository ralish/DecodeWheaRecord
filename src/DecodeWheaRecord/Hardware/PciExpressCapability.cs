...
namespace DecodeWheaRecord.Hardware {
    ...
    internal sealed class PCI_CAPABILITIES_HEADER {
        ...
        public string CapabilityID => Enum.GetName(typeof(PCI_CAPABILITY_ID), _CapabilityID);
    ...
    internal sealed class PCI_EXPRESS_CAPABILITIES_REGISTER {
        ...
        // Switched to an enumeration
        [JsonProperty(Order = 2)]
        public string DeviceType => Enum.GetName(typeof(PCI_EXPRESS_DEVICE_TYPE), (_RawBits >> 4) & 0xF); // Bits 4-7
