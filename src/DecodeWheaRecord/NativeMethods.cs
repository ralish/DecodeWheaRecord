...
namespace DecodeWheaRecord {
    internal static class NativeMethods {
        ...
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        public sealed class WHEA_ERROR_RECORD : WheaRecord {
            public WHEA_ERROR_RECORD_HEADER Header;

            /*
             * TODO
             * ANYSIZE_ARRAY fields cannot be automatically marshalled.
             */
        ...
        public static readonly Dictionary<Guid, string> NotifyTypes = new Dictionary<Guid, string> {
            ...
            { Guid.Parse("667dd791-c6b3-4c27-8a6b-0f8e722deb41"), "DMA Remapping Error (DMAr)" },       // TODO: No struct
            { Guid.Parse("cc5263e8-9308-454a-89d0-340bd39bc98e"), "INIT Record (INIT)" },               // INIT_NOTIFY_TYPE_GUID
            ...
            { Guid.Parse("cf93c01f-1a16-4dfc-b8bc-9c4daf67c104"), "PCI Express Error (PCIe)" },         // PCIe_NOTIFY_TYPE_GUID
            ...
            // Microsoft extensions
            { Guid.Parse("3e62a467-ab40-409a-a698-f362d464b38f"), "GENERIC_NOTIFY_TYPE_GUID" } // GENERIC_NOTIFY_TYPE_GUID
        };
        ...
        public static readonly Dictionary<Guid, string> SectionTypes = new Dictionary<Guid, string> {
            ...
            { Guid.Parse("81212a96-09ed-4996-9471-8d729c8e69ed"), "Firmware Error Record Reference" },                 // FIRMWARE_ERROR_RECORD_REFERENCE_GUID
            { Guid.Parse("71761d37-32b2-45cd-a7d0-b0fedd93e8cf"), "Intel VT for Directed I/O specific DMAr section" }, // TODO: No struct
            { Guid.Parse("036f84e1-7f37-428c-a79e-575fdfaa84ec"), "IOMMU specific DMAr section" },                     // TODO: No struct
            { Guid.Parse("c5753963-3b84-4095-bf78-eddad3f9c9dd"), "PCI/PCI-X Bus" },                                   // PCIXBUS_ERROR_SECTION_GUID
            { Guid.Parse("eb5e4685-ca66-4769-b6a2-26068b001326"), "PCI Component/Device" },                            // PCIXDEVICE_ERROR_SECTION_GUID
            { Guid.Parse("d995e954-bbc1-430f-ad91-b44dcb3c6f35"), "PCI Express" },                                     // PCIEXPRESS_ERROR_SECTION_GUID
            { Guid.Parse("a5bc1114-6f64-4ede-b863-3e83ed7c83b1"), "Platform Memory" },                                 // MEMORY_ERROR_SECTION_GUID
            { Guid.Parse("9876ccad-47b4-4bdb-b65e-16f193c4f3db"), "Processor Generic" },                               // PROCESSOR_GENERIC_ERROR_SECTION_GUID
            { Guid.Parse("e19e3d16-bc11-11e4-9caa-c2051d5d46b0"), "Processor Specific: ARM" },                         // ARM_PROCESSOR_ERROR_SECTION_GUID
            { Guid.Parse("dc3ea0b0-a144-4797-b95b-53fa242b6e1d"), "Processor Specific: IA32/X64" },                    // XPF_PROCESSOR_ERROR_SECTION_GUID
            { Guid.Parse("e429faf1-3cb7-11d4-bca7-0080c73c8881"), "Processor Specific: IPF" },                         // IPF_PROCESSOR_ERROR_SECTION_GUID
            { Guid.Parse("85183a8b-9c41-429c-939c-5c3c087ca280"), "MU_TELEMETRY_SECTION_GUID" },                       // MU_TELEMETRY_SECTION_GUID
            { Guid.Parse("81687003-dbfd-4728-9ffd-f0904f97597d"), "PMEM_ERROR_SECTION_GUID" },                         // PMEM_ERROR_SECTION_GUID

            // Microsoft extensions
            { Guid.Parse("e71254e8-c1b9-4940-ab76-909703a4320f"), "GENERIC_SECTION_GUID" },             // GENERIC_SECTION_GUID
            { Guid.Parse("6f3380d1-6eb0-497f-a578-4d4c65a71617"), "IPF_SAL_RECORD_SECTION_GUID" },      // IPF_SAL_RECORD_SECTION_GUID
            { Guid.Parse("1c15b445-9b06-4667-ac25-33c056b88803"), "IPMI_MSR_DUMP_SECTION_GUID" },       // IPMI_MSR_DUMP_SECTION_GUID
            { Guid.Parse("e71254e7-c1b9-4940-ab76-909703a4320f"), "NMI_SECTION_GUID" },                 // NMI_SECTION_GUID
            { Guid.Parse("ec49534b-30e7-4358-972f-eca6958fae3b"), "WHEA_DPC_CAPABILITY_SECTION_GUID" }, // WHEA_DPC_CAPABILITY_SECTION_GUID
            { Guid.Parse("e71254e9-c1b9-4940-ab76-909703a4320f"), "WHEA_ERROR_PACKET_SECTION_GUID" },   // WHEA_ERROR_PACKET_SECTION_GUID
            { Guid.Parse("8a1e1d01-42f9-4557-9c33-565e5cc3f7e8"), "XPF_MCA_SECTION_GUID" }              // XPF_MCA_SECTION_GUID
        };
        ...
        private const int WHEA_ERROR_RECORD_REVISION = 0x210;

        private const uint WHEA_ERROR_RECORD_SIGNATURE_END = uint.MaxValue;
        ...
        public sealed class WHEA_ERROR_RECORD_HEADER : WheaRecord {
            ...
            [JsonProperty(Order = 2)]
            public WHEA_REVISION Revision; // TODO: Validate
            ...
            public override void Validate() {
                if (Signature != WHEA_ERROR_RECORD_SIGNATURE) {
                    var msg = $"[{nameof(WHEA_ERROR_RECORD_HEADER)}] Expected signature \"{WHEA_ERROR_RECORD_SIGNATURE}\" but Signature field is: {Signature}";
                    ExitWithMessage(msg, 2);
                }

                if (SignatureEnd != WHEA_ERROR_RECORD_SIGNATURE_END) {
                    var msg =
                        $"[{nameof(WHEA_ERROR_RECORD_HEADER)}] Expected end signature \"{WHEA_ERROR_RECORD_SIGNATURE_END}\" but SignatureEnd field is: {SignatureEnd}";
                    ExitWithMessage(msg, 2);
                }
            }
        }
        ...
        public sealed class WHEA_PERSISTENCE_INFO {
            private ushort _Signature; // TODO: Validate?
            ...
            [JsonProperty(Order = 2)]
            public int Length => _Length[0] + (_Length[1] << 8) + (_Length[2] << 16);
        ...
        [SuppressMessage("CodeQuality", "IDE0051:Remove unused private members")]
        [SuppressMessage("Performance", "CA1823:Avoid unused private fields")]
        private const int WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_REVISION = 0x300;
        ...
        #region WHEA Error Record Section: Enumerations
        ...
        public enum WHEA_FIRMWARE_RECORD_TYPE : byte {
            IpfSal     = 0,
            SocFwType1 = 1, // Not in header
            SocFwType2 = 2  // Not in header
        }
        ...
        #region WHEA Error Record Section: Structures
        ...
        public enum WHEA_ERROR_SOURCE_DESCRIPTOR_TYPE : ushort {
            ...
            Generic      = 9,
            GenericV2    = 10,
            DeviceDriver = 11 // Just a guess as not in the headers
        }
        ...
        public sealed class WHEA_ERROR_SOURCE_DESCRIPTOR : WheaRecord {
            ...
            public override void Validate() {
                ...
                if (Length != expectedLength) {
                    msg = $"[{nameof(WHEA_ERROR_SOURCE_DESCRIPTOR)}] Expected length of {expectedLength} bytes but Length field is: {Length}";
                    ExitWithMessage(msg, 2);
                }
                ...
                if (Version != WHEA_ERROR_SOURCE_DESCRIPTOR_VERSION) {
                    msg =
                        $"[{nameof(WHEA_ERROR_SOURCE_DESCRIPTOR)}] Expected version {WHEA_ERROR_SOURCE_DESCRIPTOR_VERSION} but Version field is: {Version}";
                    ExitWithMessage(msg, 2);
                }
                ...
                if (_Type == WHEA_ERROR_SOURCE_TYPE.PCIe) {
                    ...
                    /*
                     * Using any PCIe AER structure is safe as the Type field
        ...
        public sealed class WHEA_PCI_SLOT_NUMBER {
            ...
            [JsonProperty(Order = 2)]
            public byte FunctionNumber => (byte)((_DevFuncNumber & 0xE0) >> 5); // Bits 5-7
        ...
        public sealed class WHEA_GENERIC_ERROR_DESCRIPTOR {
            ...
            // Next five fields are equivalent to GEN_ADDR struct
            [JsonProperty(Order = 6)]
            ...
            [JsonProperty(Order = 10)]
            public long ErrStatusAddress; // WHEA_PHYSICAL_ADDRESS
        ...
        public sealed class WHEA_GENERIC_ERROR_DESCRIPTOR_V2 {
            ...
            [JsonProperty(Order = 16)]
            public long ReadAckAddress; // WHEA_PHYSICAL_ADDRESS
        ...
        /*
         * TODO
         * Structures not yet associated to any event log entry:
        ...
        public enum WHEA_EVENT_LOG_ENTRY_ID : uint {
            ...
            StartedReportHwError    = 0x80000005, // WHEAP_STARTED_REPORT_HW_ERROR
        ...
        public sealed class WHEA_EVENT_LOG_ENTRY_HEADER : WheaRecord {
            ...
            // TODO: Validate against Type and PayloadLength
            [JsonProperty(Order = 3)]
            public uint Length;
            ...
            public override void Validate() {
                if (Signature != WHEA_ERROR_LOG_ENTRY_SIGNATURE) {
                    var msg =
                        $"[{nameof(WHEA_EVENT_LOG_ENTRY_HEADER)}] Expected signature \"{WHEA_ERROR_LOG_ENTRY_SIGNATURE}\" but Signature field is: {Signature}";
                    ExitWithMessage(msg, 2);
                }

                if (Version != WHEA_ERROR_LOG_ENTRY_VERSION) {
                    var msg = $"[{nameof(WHEA_EVENT_LOG_ENTRY_HEADER)}] Expected version {WHEA_ERROR_LOG_ENTRY_VERSION} but Version field is: {Version}";
                    ExitWithMessage(msg, 2);
                }
            }
        }
        ...
        public sealed class WHEAP_PSHED_INJECT_ERROR : WheaRecord {
            ...
            public uint InjectionStatus; // NTSTATUS
        ...
        public sealed class WHEA_SRAR_DETAIL_EVENT : WheaRecord {
            ...
            public uint PageOfflineStatus; // NTSTATUS
        ...
        public sealed class WHEAP_PCIE_READ_OVERRIDES_ERR : WheaRecord {
            ...
            [JsonProperty(Order = 2)]
            public uint FailureStatus; // NTSTATUS
        }
        ...
        public sealed class WHEAP_SPURIOUS_AER_EVENT : WheaRecord {
            ...
            public override void Validate() {
                if (_ErrorHandlerType != WHEA_PCIEXPRESS_DEVICE_TYPE.PciExpressRootPort
                    && _ErrorHandlerType != WHEA_PCIEXPRESS_DEVICE_TYPE.PciExpressDownstreamSwitchPort
                    && _ErrorHandlerType != WHEA_PCIEXPRESS_DEVICE_TYPE.PciExpressRootComplexEventCollector) {
        ...
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        public sealed class WHEAP_SRAS_TABLE_ENTRIES_EVENT : WheaRecord {
            public uint LogNumber;
            public uint NumberSignals;

            /*
             * TODO
             * An ANY_SIZE array is tricky to marshall in .NET and the format
             * of the data is undocumented so we can't do much with it anyway.
             */
            //UINT8 Data[ANY_SIZE];
        }
        ...
        public sealed class WHEAP_ROW_FAILURE_EVENT : WheaRecord {
            public uint LowOrderPage;  // PFN_NUMBER
            public uint HighOrderPage; // PFN_NUMBER
        }
        ...
        public sealed class WHEA_NOTIFICATION_DESCRIPTOR : WheaRecord {
            ...
            public override void Validate() {
                ...
                if (Length != expectedLength) {
                    var msg = $"[{nameof(WHEA_NOTIFICATION_DESCRIPTOR)}] Expected length of {expectedLength} bytes but Length field is: {Length}";
                    ExitWithMessage(msg, 2);
                }
